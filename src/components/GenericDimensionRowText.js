...
<div :class="adjustableTextClass()" class="c-dim-row--left">
...
<div :class="adjustableTextClass()" class="c-dim-row--medium">
<span class="c-dim-row__large c-dim-amount">
{{ amountText }}
</span>
<span
v-if="rate.neq(0) && showPercentage"
class="c-dim-row__small c-dim-row--rate"
>
{{ rateText }}
</span>
</div>

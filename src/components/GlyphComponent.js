...
from "../../src/components/modals/options/SelectGlyphInfoDropdown.js";
...
default {
  ...
  methods: {
    ...
    showTooltip() {
      ...
      if (
      AutoGlyphProcessor.sacMode === AUTO_GLYPH_REJECT.SACRIFICE || (AutoGlyphProcessor.sacMode === AUTO_GLYPH_REJECT.REFINE_TO_CAP && this.refineReward === 0)) {
    ...
    glyphBorderStyle() {
      ...
      else borderAttrs = rarityBorderStyles[getRarity(this.glyph.strength)
        .name.toLowerCase()];

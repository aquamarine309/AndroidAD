    ...
    update() {
      ...
      if (inSpecialRun) {
        ...
        if (PelleRifts.recursion.milestones[2].canBeApplied || GalaxyGenerator.spentGalaxies > 0) {
          ...
          setLinearProgress(
          (Math.min(Currency.timeTheorems.max.toNumber() / 12900, 1) + Math.min(EternityChallenges.completions / 60, 1)) / 2,
...
: "Infinity Dimension"}`;
  ...
  template: `<div class="c-progress-bar">
<div

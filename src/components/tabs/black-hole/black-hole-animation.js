export const BlackHoleAnimation = (function() {
  ...
  class Planet extends Dot {
    ...
    performDraw(context) {
      ...
      context.arc(x + 160, y + 160, PLANET_SIZE, 0, 2 * Math.PI);
  ...
  class Hole extends Dot {
    ...
    performDraw(context) {
      ...
      const glow = context.createRadialGradient(160, 160, 0, 160, 160, this.size * 2);
  ...
  class Particle extends Dot {
    ...
    drawTrail(context) {
      ...
      if (this.isBlob) {
        ...
        context.lineWidth *= 1;
        context.moveTo(x + 160, y + 160);
        context.lineTo(lastX + 160, lastY + 160);
      }
    }

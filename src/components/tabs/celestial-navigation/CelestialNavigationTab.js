import svgPanZoom from "../../../../modules/svg-pan-zoom.js";
import { CELESTIAL_NAV_DRAW_ORDER }
from "../../../core/secret-formula/celestials/navigation.js";

import NodeBackground from "./NodeBackground.js";
import NodeOverlay from "./NodeOverlay.js";
import NodeRing from "./NodeRing.js";
import ProgressConnector from "./ProgressConnector.js";
...
export default {
  ...
  computed: {
    db() {
      return {...GameDatabase.celestials.navigation, ...GameDatabase.celestials.navSigils
      };
    },
    drawOrder() {
      const db = this.db;
  ...
  created() {
    this.nodeState = Object.keys(this.db)
      .mapToObject(
    name => name, () => ({
      visible: false,
      complete: 0,

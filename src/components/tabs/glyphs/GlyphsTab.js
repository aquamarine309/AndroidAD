...
export default {
  ...
  computed: {
    ...
    tabName() {
      return this.showOptions ? "Glyphs" : "options"
    }
  },
  methods: {
    update() {
      ...
      this.headerPage = player.reality.glyphs.headerPage;
      this.showOptions = player.reality.glyphs.showOptions;
  ...
  watch: {
    showOptions(newValue) {
      player.reality.glyphs.showOptions = newValue;
    }
  },
  template: `
  <div>
    <div class="l-glyphs-tab">
      <button
      class="c-reality-upgrade-btn o-glyph-toggle-options"
      @click="showOptions = !showOptions"
      >
        Switch to {{ tabName }} tab
      </button>
      <div class="c-glyphs-page">
      <Transition name="a-header-page" mode="out-in">
      <div
      class="l-reality-button-column"
      key="options"
      v-if="showOptions"
      >
        <GlyphPeek />

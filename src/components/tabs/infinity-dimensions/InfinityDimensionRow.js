...
export default {
  ...
  watch: {
    isAutobuyerOn(newValue) {
      Autobuyer.infinityDimension(this.tier)
        .isActive = newValue;
    }
  },
  methods: {
    update() {
      ...
      this.hasPrevTier = tier === 1 || InfinityDimension(tier - 1)
        .isUnlocked;
      ...
      this.isAutobuyerUnlocked = Autobuyer.infinityDimension(tier)
        .isUnlocked;
  ...
  >
    ...
    <div class="l-dim-row-multi-button-container c-dim-tooltip-container">
      <AndroidTooltip
        :text="costTooltip"
        :condition="!isUnlocked && !canUnlock"
      >
        <PrimaryButton

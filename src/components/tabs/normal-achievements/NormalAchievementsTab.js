...
export default {
  ...
  methods: {
    update() {
      ...
      this.achTPEffect = RealityUpgrade(8)
        .config.effect();
      ...
      this.achMultToIDS = Achievement(75)
        .isUnlocked;
      this.achMultToTDS = EternityUpgrade.tdMultAchs.isBought;
      this.achMultToTP = RealityUpgrade(8)
        .isBought;
  ...
  template: `<div class="l-achievements-tab">
<div class="c-subtab-option-container">
<PrimaryToggleButton
v-model="hideCompletedRows"
label="Hide completed rows:"
class="o-achievement-header-btn"
/>
<PrimaryToggleButton

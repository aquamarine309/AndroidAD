...
unlocked the upgrade.`,
  ...
  template: `<div class="l-reality-upgrade-grid">
    <div class="c-reality-upgrade-infotext">
      ...
      <br>
      You can double-click upgrades with <i class="fas fa-lock-open" /> to make the game prevent you
    ...
    <div class="l-reality-upgrade-grid__container">
      <div
        v-for="row in 5"
        :key="row"

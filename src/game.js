...
export function gameLoop(passDiff, options = {}) {
  ...
  if (player.options.hibernationCatchup && passDiff === undefined && realDiff > 3e3) {
    GameIntervals.gameLoop.stop();
    simulateTime(realDiff / 1000, true, realDiff < 6e4);
          ...
          ui.$viewModel.modal.progressBar = {
            ...
            },
            {
              ...
              click: () => {
                ...
                progress.maxIter -= progress.remaining - 100;
...
EventHub.ui.on(GAME_EVENT.CLOSE_MODAL, () => EventHub.dispatch(GAME_EVENT.OVERLAY_UPDATE));